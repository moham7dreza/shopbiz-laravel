...
namespace Modules\Comment\Post\Providers;
...
class PostCommentServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    private string $namespace = 'Modules\Comment\Post\Http\Controllers';
     ...
     * @var string
     */
    private string $name = 'PostComment';
     ...
     * @var string
     */
    private string $routePath = '/../Routes/post_comment_routes.php';
