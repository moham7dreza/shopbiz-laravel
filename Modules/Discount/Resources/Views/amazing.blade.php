        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('discount.amazingSale.create') }}" class="btn btn-info btn-sm">افزودن کالا به لیست
                        شگفت انگیز</a>
                        ...
                        @foreach ($amazingSales as $amazingSale)
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('discount.amazingSale.edit', $amazingSale->id) }}"
                                       class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                    <form class="d-inline"
                                          action="{{ route('discount.amazingSale.destroy', $amazingSale->id) }}"
                                          method="post">
                                        @csrf
                                        {{ method_field('delete') }}
