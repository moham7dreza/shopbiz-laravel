        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('discount.commonDiscount.create') }}" class="btn btn-info btn-sm">ایجاد تخفیف
                        عمومی</a>
                        ...
                        @foreach ($commonDiscounts as $commonDiscount)
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('discount.commonDiscount.edit', $commonDiscount->id) }}"
                                       class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    <form class="d-inline"
                                          action="{{ route('discount.commonDiscount.destroy', $commonDiscount->id) }}"
                                          method="post">
                                        @csrf
                                        {{ method_field('delete') }}
