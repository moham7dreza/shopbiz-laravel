...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-16"><a href="{{ route('copanDiscount.index') }}"> کوپن تخفیف</a></li>
            <li class="breadcrumb-item font-size-16 active" aria-current="page"> ویرایش کوپن تخفیف</li>
        </ol>
    </nav>
