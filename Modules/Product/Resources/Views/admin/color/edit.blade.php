                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="color" value="{{ old('color', $color->color) }}"
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control form-control-sm" id="status">
                                        <option value="0" @if (old('status', $color->status) == 0) selected @endif>
                                            غیرفعال
                                        </option>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sold_number"
                                           value="{{ old('sold_number', $color->sold_number) }}"
                                           class="form-control form-control-sm">
                                </div>
                                @error('sold_number')
                                <span class="alert alert-danger -p-1 mb-3 d-block font-size-80" role="alert">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="frozen_number"
                                           value="{{ old('frozen_number', $color->frozen_number) }}"
                                           class="form-control form-control-sm">
                                </div>
                                @error('frozen_number')
                                <span class="alert alert-danger -p-1 mb-3 d-block font-size-80" role="alert">
