...
namespace Modules\Category\Product\Providers;
...
class ProductCategoryServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    private string $namespace = 'Modules\Category\Product\Http\Controllers';
     ...
     * @var string
     */
    private string $routePath = '/../Routes/product_category_routes.php';
