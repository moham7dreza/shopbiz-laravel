...
class AjaxResponses
{
     ...
     * @return JsonResponse
     */
    public static function SuccessResponse(string $message = 'The operation was successful.'): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public static function FailedResponse(string $message = 'The operation was not successful.'): JsonResponse
    {
