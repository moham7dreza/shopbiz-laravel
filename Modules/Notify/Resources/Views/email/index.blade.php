                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <th>#</th>
                            <th>
                                <x-panel-sort-btn route="email.index" title="عنوان اطلائیه" property="subject" />
                            </th>
                            <th>متن ایمیل</th>
                            <th>
                                <x-panel-sort-btn route="email.index" title="تاریخ ارسال" property="published_at" />
                            </th>
                            <th>ارسال شده</th>
                            <th>
                                <x-panel-sort-btn route="email.index" title="وضعیت" property="status"/>
                            </th>
