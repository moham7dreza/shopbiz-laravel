            ...
            <form action="{{ route('auth.login') }}" method="post">
                ...
                <section class="login-wrapper">
                    ...
                    <section class="mt-3 font-size-70 register">
                        ...
                        <a href="{{ route('auth.reset-password-form') }}" class="text-decoration-none font-weight-bold">
                            بازیابی کلمه عبور
                        </a>
                    </section>
                    ...
                    <section class="login-terms-and-conditions d-flex align-items-center">
                        ...
                        <a href="#" class="text-decoration-none mx-1 font-weight-bold"> شرایط و قوانین </a>را خوانده ام
                        و پذیرفته ام
                    </section>
                    @error('rules')
