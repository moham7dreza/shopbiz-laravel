<aside id="sidebar" class="sidebar col-md-3">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="">
            <form action="{{ route('customer.market.brand.products', [$brand]) }}" class="d-flex">
                <input name="brand_products_search" class="sidebar-input-text" type="text"
                       placeholder="جستجو بر اساس نام، برند ...">
                <button type="submit" class="btn btn-light btn-sm"><i class="fa fa-check"></i></button>
            </form>
        </section>
    </section>
    <form action="{{ route('customer.market.brand.products', [$brand]) }}">
...
{{--        @foreach($brand->attributes as $attribute)--}}
{{--            <section class="content-wrapper bg-white p-3 rounded-2 mb-3">--}}
{{--                <section class="content-header mb-3">--}}
{{--                    <section class="d-flex justify-content-between align-items-center">--}}
{{--                        <h2 class="content-header-title content-header-title-small">--}}
