                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        ...
                        <section class="col-md-3">
                            <x-home-cart-price :cartItems="$cartItems" :commonDiscount="$order->commonDiscount"
                                               :copanDiscount="$order->copan"
                                               :finalAmount="$order->order_final_amount" formId="payment_submit"
                                               buttonText="تکمیل فرآیند خرید"/>
                        </section>
                    </section>
                </section>
            </section>
